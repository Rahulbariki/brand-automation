...
import { signup, googleLogin } from "../hooks/useApi";
            ...
            >
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-extrabold mb-2">
                        Join the <span className="gradient-text">Universe</span>
                    </h1>
                    <p className="text-text-secondary text-sm">Create your account and start building your brand</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <AnimatedButton type="submit" disabled={loading} className="w-full py-3.5 justify-center">
                        {loading ? <Loader2 size={18} className="animate-spin" /> : <><ArrowRight size={16} /> Create Account</>}
                    </AnimatedButton>
                </form>
                ...
                <p className="text-center text-text-muted text-sm mt-6">
                    ...
                    <Link to="/login" className="text-[var(--primary)] hover:underline font-semibold">Sign in</Link>
                </p>
            </motion.div>
        </div>
    );
